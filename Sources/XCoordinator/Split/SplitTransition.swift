...
extension Transition where RootViewController: UISplitViewController {
	...
	@MainActor public static func set(_ presentables: [any Presentable]) -> Transition {
    ...
    @available(iOS 14, *)
	@MainActor public static func set(_ presentable: (any Presentable)?, for column: UISplitViewController.Column) -> Transition {
