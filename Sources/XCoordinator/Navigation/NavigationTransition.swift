...
extension Transition where RootViewController: UINavigationController {
    ...
    ///         on this presentable.
    ///
	@MainActor public static func push(_ presentable: any Presentable, animation: Animation? = nil) -> Transition {
    ...
    ///         on this presentable.
    ///
	@MainActor public static func pop(to presentable: any Presentable, animation: Animation? = nil) -> Transition {
        Transition(presentables: [presentable],
                   animationInUse: animation?.dismissalAnimation
        ) { rootViewController, options, completion in
    ...
    ///
	@MainActor public static func set(_ presentables: [any Presentable], animation: Animation? = nil) -> Transition {
